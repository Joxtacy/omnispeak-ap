...
#define AP_LOC_BASE_LEVEL_COMPLETE	800810000
#define AP_LOC_BASE_KEYGEM			800820000
#define AP_LOC_BASE_KEYCARD			800830000
#define AP_LOC_BASE_POINTSANITY		800840000

//spacing
#define AP_LOC_EPISODE_STRIDE		1000
#define AP_LOC_LEVEL_STRIDE			100
#define AP_LOC_ITEM_STRIDE			1

#define AP_EPISODE_CK4				4
#define AP_EPISODE_CK5				5
